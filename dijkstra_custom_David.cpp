...
#include "dijkstra_tempvar_serial_David.cpp"
//#include "dijkstra_pthread_modified_David.cpp"
//#include "dijkstra_pthread_new_modified_David.cpp"
...
int main() //Driver Function for Dijkstra SSSP
{
    ...
    int sz = numNodes + 1;//Is this necessary? -- David
    int dis[sz];
    ...
    Dijkstra(source,sz,a,dis);//SSSP from source (Also passing number of vertices as parameter)
    ...
    */
    ...
    std::cout << numNodes << ", " << edgeDensity << ", " << edges << ", ";
