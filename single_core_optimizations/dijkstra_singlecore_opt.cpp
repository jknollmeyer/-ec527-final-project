...
#include <climits>
#include <time.h>
#include "dijkstra_lib_singlecore_opt.cpp"
...
#define numNodesStart 500
#define numNodesStop 5000
#define nodeStep 500          
...
int main() //Driver Function for Dijkstra SSSP
{
    ...
    for(int numNodes = numNodesStart; numNodes <= numNodesStop; numNodes += nodeStep){
